...
public class AcceptDeliveryView extends JFrame{
	...
	private void initialize() {
		...
		lbl_title.setIcon(new javax.swing.ImageIcon("./Logos/acceptDelivery.png"));
		panel.add(lbl_title);
		...
		btn_accept.setBounds(282, 258, 89, 35);
