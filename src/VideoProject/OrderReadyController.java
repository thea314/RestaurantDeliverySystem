...
public class OrderReadyController implements ActionListener, ListSelectionListener {
	...
	//constructor
	public OrderReadyController(OrderReadyView view, int restauranteurId, User user) {
		this.view = view;
		...
		orderTitle = db.restoOrderListReady(restoId);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((JButton)e.getSource() == view.getBtn_complete()) {
			...
			if (confirmAddMenu == JOptionPane.YES_OPTION) {
				...
				db.orderReady(currentOrder.getId());
				JOptionPane.showMessageDialog(null, "Order Waiting for delivery!!", "Complete", JOptionPane.INFORMATION_MESSAGE);
